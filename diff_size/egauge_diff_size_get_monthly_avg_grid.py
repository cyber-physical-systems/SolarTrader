...
def main(argv):
    ...
    for sharing_algorithm in sharing_algorithms:
        ...
        # output_path = f'{workspace}data/{dataset}/grid/{sharing_algorithm}.csv'
        output_path = workspace + 'figures/diff_size_grid/fig_data/' + sharing_algorithm + '.csv'
